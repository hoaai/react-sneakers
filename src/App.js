...
function App() {
		...
		async function fetchData() {
			...
			try {
				const [cartResponse, favoriteResponse, itemsResponse] = await Promise.all([
					axios.get("https://648ea6c675a96b66444421a3.mockapi.io/cart"),
					axios.get("https://6491cdea2f2c7ee6c2c8eea4.mockapi.io/favorite"),
					axios.get("https://648ea6c675a96b66444421a3.mockapi.io/items")
				])
	...
	const onRemoveItem = async (id) => {
		try {
			await axios.delete(`https://648ea6c675a96b66444421a3.mockapi.io/cart/${id}`);
			// setCartItems(prev => [...prev, obj])
	...
	return (
		<AppContext.Provider value={{ items, cartItems, favorites, isItemAdded, onAddToFavorite, onAddToCart, setCartOpened, setCartItems, isLoading }}>
